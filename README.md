...
poetry build
poetry run twine check dist/blender_asset_tracer-1.23-beta0.tar.gz dist/blender_asset_tracer-1.23-beta0-*.whl
poetry run twine upload -r bat dist/blender_asset_tracer-1.23-beta0.tar.gz dist/blender_asset_tracer-1.23-beta0-*.whl
```
