...
poetry build
twine check dist/blender_asset_tracer-1.18-dev0.tar.gz dist/blender_asset_tracer-1.18-dev0-*.whl
twine upload -r bat dist/blender_asset_tracer-1.18-dev0.tar.gz dist/blender_asset_tracer-1.18-dev0-*.whl
```
