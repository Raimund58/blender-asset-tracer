...
class BlendFileHeader:
        ...
        if is_legacy_header:
            ...
            if byte_7 == b"_":
                ...
                raise exceptions.BlendFileError(
                    "invalid pointer size %r" % byte_7, path
                )
            ...
            if byte_8 == b"v":
                ...
                raise exceptions.BlendFileError(
                    "invalid endian indicator %r" % byte_8, path
                )
            ...
            if header_size != 17:
                raise exceptions.BlendFileError(
                    "unknown file header size %d" % header_size, path
                )
            ...
            if self.file_format_version != 1:
                raise exceptions.BlendFileError(
                    "unsupported file format version %r" % self.file_format_version,
                    path,
                )
    ...
    def create_block_header_struct(
        self,
    ) -> typing.Tuple[
        struct.Struct, typing.Type[typing.Union[BHead4, SmallBHead8, LargeBHead8]]
    ]:
        """
